...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    if (!res.ok) console.error("GET /api/about upstream error:", res.status, data);
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    console.log("POST /api/about body:", JSON.stringify(body));
    ...
    console.log("POST /api/about response:", response.status, JSON.stringify(data));
    if (!response.ok) console.error("POST /api/about upstream error:", response.status, data);
